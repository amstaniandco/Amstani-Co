...
export default function ProductGrid({ storeId, storeName = "" }: { storeId?: string | null; storeName?: string }) {
  ...
  return (
    <>
      {/* ── Catalog banner ───────────────────────────────────────────────── */}
      <div className="mt-5 rounded-2xl bg-white shadow-sm dark:border dark:border-slate-700 dark:bg-slate-800 flex items-center justify-center py-5">
        <p className="text-2xl font-black tracking-tight text-slate-900 dark:text-slate-100 uppercase" style={{ WebkitTextStroke: "1px currentColor" }}>
