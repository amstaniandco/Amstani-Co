          ...
          <div className="mt-4 flex items-center justify-between gap-2">
            ...
            {store?.ownerPhone ? (
              <a
                ...
                className="flex h-11 flex-1 items-center justify-center rounded-2xl border border-gray-200 text-emerald-600 hover:bg-emerald-50"
              >
              ...
              <button
                disabled
                className="flex h-11 flex-1 items-center justify-center rounded-2xl border border-gray-200 text-gray-300 cursor-not-allowed"
              >
                <span className="sr-only">WhatsApp</span>
                <svg
                  viewBox="0 0 24 24"
