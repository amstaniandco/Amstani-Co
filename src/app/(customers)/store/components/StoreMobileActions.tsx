  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <Link
          href={
            store?._id ? `/store/offer?storeId=${store._id}` : "/store/offer"
          }
          className="rounded-3xl border border-gray-200 bg-white p-4 transition hover:shadow-md dark:border-slate-700 dark:bg-slate-800"
        >
          <div className="flex items-center gap-3 text-slate-900 dark:text-slate-100">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                Connect to learn more about available opportunities
              </p>
            </div>
          </div>
          <div className="w-full flex items-center justify-center">
            <div className="mt-4 inline-flex h-10 items-center justify-center rounded-full border border-slate-200 px-4 text-center text-sm font-semibold text-slate-700 dark:border-slate-600 dark:text-slate-200">
        ...
        <div
          ...
          className="rounded-3xl border border-gray-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-800"
        >
          <div className="flex items-center gap-3 text-slate-900 dark:text-slate-100">
          ...
          <div className="mt-4 flex items-center justify-between gap-2">
            <button className="flex h-11 flex-1 items-center justify-center rounded-2xl border border-gray-200 text-blue-600 hover:bg-blue-50 dark:border-slate-600 dark:hover:bg-blue-500/10">
            ...
            <button className="flex h-11 flex-1 items-center justify-center rounded-2xl border border-gray-200 text-pink-500 hover:bg-pink-50 dark:border-slate-600 dark:hover:bg-pink-500/10">
            ...
            {store?.ownerPhone ? (
              <a
                ...
                className="flex h-11 flex-1 items-center justify-center rounded-2xl border border-gray-200 text-emerald-600 hover:bg-emerald-50 dark:border-slate-600 dark:hover:bg-emerald-500/10"
              >
              ...
              <button
                disabled
                className="flex h-11 flex-1 items-center justify-center rounded-2xl border border-gray-200 text-gray-300 cursor-not-allowed dark:border-slate-600 dark:text-slate-600"
              >
                <span className="sr-only">WhatsApp</span>
                <svg
                  viewBox="0 0 24 24"
      ...
      <Link
        ...
        className="flex items-center justify-between rounded-3xl border border-gray-200 bg-white px-4 py-5 text-sm font-semibold text-slate-900 transition hover:shadow-md dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
      >
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-slate-100 text-slate-700 dark:bg-slate-700 dark:text-slate-200">
            <svg
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
