    ...
    <div className="ui-panel mt-5 rounded-2xl bg-white p-5 shadow-sm dark:border dark:border-slate-700 dark:bg-slate-800">
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div className="flex items-start gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-red-50 text-red-600 dark:bg-slate-700 dark:text-rose-300">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
          ...
          <div className="flex flex-col">
            <h3 className="mb-2 text-sm font-bold text-slate-900 dark:text-slate-100">Join Our Live Streams</h3>
            <p className="text-sm text-slate-500 dark:text-slate-300">Don’t miss out exclusive opportunities</p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-3">
          <button
            type="button"
            aria-label="Facebook"
            className="flex h-11 w-11 items-center justify-center rounded-xl border border-gray-200 text-blue-600 hover:bg-gray-50 dark:border-slate-600 dark:hover:bg-slate-700"
          >
          ...
          <button
            ...
            className="flex h-11 w-11 items-center justify-center rounded-xl border border-gray-200 text-pink-500 hover:bg-gray-50 dark:border-slate-600 dark:hover:bg-slate-700"
          >
          ...
          <button
            type="button"
            aria-label="WhatsApp"
            className="flex h-11 w-11 items-center justify-center rounded-xl border border-gray-200 text-emerald-600 hover:bg-gray-50 dark:border-slate-600 dark:hover:bg-slate-700"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
