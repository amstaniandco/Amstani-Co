...
export default function WishlistPage() {
  ...
  return (
    <div className="rounded-2xl bg-white dark:bg-slate-800 px-6 py-6 shadow-sm">
      ...
      {loading ? (
        <div className="py-12 text-center text-sm text-slate-400 dark:text-slate-500">Loading wishlist…</div>
      ) : items.length === 0 ? (
        <div className="py-12 text-center text-sm text-slate-400 dark:text-slate-500">Your wishlist is empty.</div>
      ) : (
