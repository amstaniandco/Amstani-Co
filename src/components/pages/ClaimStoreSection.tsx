  ...
  return (
    <section className="bg-[#f3f4f6] py-6 sm:py-8">
      <div className="mx-auto w-full max-w-[1450px] px-6">
        <div className="relative min-h-[430px] overflow-hidden rounded-2xl border border-slate-300/30 bg-gradient-to-r from-[#201f19] via-[#25231c] to-[#2d3128] px-12 py-12 sm:min-h-[520px] sm:px-16 sm:py-14">
          ...
          <div className="relative grid min-h-[430px] items-center gap-y-8 gap-x-4 lg:gap-y-4 lg:grid-cols-[minmax(0,1fr)_560px]">
            <div className="text-center lg:text-left">
              ...
              <p className="mx-auto mt-5 max-w-[620px] text-2xl leading-relaxed text-slate-300 sm:text-[26px] lg:mx-0">
            ...
            <div className="relative mx-auto w-full max-w-[560px]">
              ...
              <div className="relative rotate-2 overflow-hidden rounded-[30px] border border-[#86d7e2]/70 bg-[#0f2026] px-7 py-6 shadow-[0_22px_32px_rgba(0,0,0,0.45)]">
                ...
                <div className="relative z-10 flex items-start justify-between">
                  <div className="h-11 w-11 rounded-sm bg-[repeating-linear-gradient(135deg,#76d0df_0_4px,transparent_4px_9px)]" />
                  <div className="text-right text-xs text-slate-400">
                    <p>GOLDEN TICKET ID</p>
                    <p className="text-2xl font-semibold text-slate-200">AM-882-991</p>
                  </div>
                </div>

                <div className="relative z-10 mt-4">
                  <p className="text-4xl font-extrabold tracking-wide text-slate-100">STORE OWNER</p>
                  <p className="mt-1 text-sm tracking-[0.28em] text-[#6dc6d5]">EXCLUSIVE MEMBERSHIP</p>
                </div>

                <div className="relative z-10 mt-6 flex items-center justify-between">
                  <div className="h-16 w-16 rounded-2xl border border-[#54432f] bg-[#2b2a1f]" />
                  <p className="text-base text-slate-400">Limited Edition Access</p>
                </div>
              </div>
            </div>
          </div>
