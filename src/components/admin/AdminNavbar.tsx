      ...
      <div className="relative flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div ref={notifRef} className="relative">
            ...
            {notifOpen && (
              <div
                className="absolute left-0 top-full z-50 mt-2 flex max-h-[60vh] w-[340px] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_20px_50px_-12px_rgba(15,23,42,0.3)] lg:left-auto lg:right-0"
              >
